...
namespace NGCP.UGV
{
    public class CommProtocol
    {
        ...
        public void sendMode(DriveMode mode, byte id = 1)
        {
            NGCP.VehicleSystemStatus vss = new NGCP.VehicleSystemStatus((byte)NodeID, (byte)mode);
            Node.Send(vss, id);            
        }

        public void sendDriveState(DriveState state, byte id = 1)
        {
        ...
        public void SendArmCommand(byte armPartID, int position, byte id = 1)
        {
