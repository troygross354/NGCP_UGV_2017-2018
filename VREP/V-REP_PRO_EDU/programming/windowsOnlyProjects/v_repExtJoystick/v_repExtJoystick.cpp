...
{ // This is called just once, at the start of V-REP
    ...
    int inArgs1[]={0};
    simRegisterCustomLuaFunction(LUA_GETCOUNT,"number count=simExtJoyGetCount()",inArgs1,LUA_GETCOUNT_CALLBACK);

    int inArgs2[]={1,sim_lua_arg_int};
    simRegisterCustomLuaFunction(LUA_GETDATA,"table_3 axes, number buttons,table_3 rotAxes,table_2 slider,table_4 pov=simExtJoyGetData(number deviceIndex)",inArgs2,LUA_GETDATA_CALLBACK);
