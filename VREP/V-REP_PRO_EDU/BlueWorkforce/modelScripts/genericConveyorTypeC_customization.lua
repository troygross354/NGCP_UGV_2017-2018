...
---[[
    ...
    simInsertPathCtrlPoints(path,1,0,18,pts)
    local l=simGetPathLength(path)
...
if (sim_call_type==sim_customizationscriptcall_initialization) then
    ...
    backSide=simGetObjectHandle('genericConveyorTypeC_backSide')
    frontSide=simGetObjectHandle('genericConveyorTypeC_frontSide')
    leftSide=simGetObjectHandle('genericConveyorTypeC_leftSide')
    rightSide=simGetObjectHandle('genericConveyorTypeC_rightSide')
    base=simGetObjectHandle('genericConveyorTypeC_base')
    baseBack=simGetObjectHandle('genericConveyorTypeC_baseBack')
    baseFront=simGetObjectHandle('genericConveyorTypeC_baseFront')
    padBase=simGetObjectHandle('genericConveyorTypeC_padBase')
    pad=simGetObjectHandle('genericConveyorTypeC_pad')
    path=simGetObjectHandle('genericConveyorTypeC_path')
